...
fun <T: ScLibraryPacket> registerClientReceiver(id: Identifier, factory: (buf: PacketByteBuf) -> T) {
...
fun <T: ScLibraryPacket> registerServerReceiver(id: Identifier, factory: (buf: PacketByteBuf) -> T) {
